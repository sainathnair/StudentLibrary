...
CREATE TABLE `student_books` (
  ...
  UNIQUE KEY `UK_istnb8wmvs13e6igoqs9b0997` (`book_id`),
  CONSTRAINT `FKdfl8blsn6ci6yf4jujap9tua8` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`),
  CONSTRAINT `FKruwc4b70f1hbye9xkgmb7kqx9` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`)
...
LOCK TABLES `student_books` WRITE;
